...
const TRANSLATIONS = {
  de: {
    ...
    termsBtn: 'Nutzungsbedingungen & Datenschutz',
    favTitle: 'Meine Lieblingsprodukte',
    favSub: 'Diese nutze ich selbst & empfehle ich',
    cozyvibeTitle: 'Neue Produkt-Tipps auf CozyVibe',
    cozyvibeSub: 'Beauty & Skincare Trends · Amazon Finds jede Woche auf Pinterest',
    footerImprint: 'Impressum',
    footerPrivacy: 'Datenschutz',
    footerTerms: 'Nutzungsbedingungen',
    pdwTitle: 'Produkt der Woche',
    pdwAd: 'Anzeige',
  ...
  en: {
    ...
    yourName: 'Your Name',
    saveSettings: 'Save ✓',
    favTitle: 'My Favorite Products',
    favSub: 'What I use myself & recommend',
    cozyvibeTitle: 'New product tips on CozyVibe',
    cozyvibeSub: 'Beauty & skincare trends · Amazon finds every week on Pinterest',
    footerImprint: 'Imprint',
    footerPrivacy: 'Privacy',
    footerTerms: 'Terms',
    pdwTitle: 'Product of the Week',
    pdwAd: 'Ad',
